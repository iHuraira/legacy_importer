...
def task_row(config: ImportConfig, run_id: UUID, sample_id: UUID, tool_name: str, now: datetime) -> dict[str, Any]:
...
def import_artifact(
    ...
    task = task_row(config, run_id, sample_id, tool_name, now)
